...
typedef enum {
   ...
   _PHX_ENUM( PHX_FBD_SETANDGET, PHX_BOARD_VARIANT_NAME,           120 ),
...
typedef enum {
   ...
   PHX_ACQ_AUTO_RESTART_NONE          = (int) ((ui32) PHX_ACQ_AUTO_RESTART + 0x01),
   PHX_ACQ_AUTO_RESTART_SYNC_LOST     = (int) ((ui32) PHX_ACQ_AUTO_RESTART + 0x02),
   PHX_ACQ_AUTO_RESTART_FIFO_OVERFLOW = (int) ((ui32) PHX_ACQ_AUTO_RESTART + 0x04),
   ...
   PHX_INTRPT_ACQ_AUTO_RESTARTED = 0x00080000,
...
typedef enum {
   ...
   _PHX_ENUM( PHX_ACQUIRE, PHX_START_RESTART_IMMEDIATELY,      20 ),
